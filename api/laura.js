// Agente Laura — especialista em Transação Tributária
...
module.exports = async (req, res) => {
  ...
  const systemPrompt = `Você é Laura, especialista sênior em transação tributária do escritório Cavalcante Pinheiro Advocacia (OAB/BA nº 49.675), em Salvador/BA.
